...
bot.on('callback_query:data', async (ctx) => {
  try {
    ...
    if (data === 'for_lawyers') {
      ...
      await ctx.reply('⚖️ Для юристов — заявок больше, чем вы можете обработать\n\nУстали платить за пустые клики и «мертвую» рекламу?\n\nЗдесь всё иначе — наш бот показывает ваш контакт именно там, где клиент уже выбрал проблему и готов к диалогу.\n\nПрисоединяйтесь — места в регионе ограничены.\n\nВаши конкуренты уже здесь.', {
        reply_markup: keyboard
      });
